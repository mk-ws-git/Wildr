...
async def create_sighting(
    ...
    sighting = Sighting(
        ...
        weather_feels_like_c=weather["feels_like_c"] if weather else None,
        weather_wind_speed_ms=round(weather["wind_kph"] / 3.6, 2) if weather else None,
        weather_wind_deg=weather.get("wind_deg") if weather else None,
        weather_humidity=weather["humidity"] if weather else None,
        weather_description=weather["description"] if weather else None,
        weather_code=weather.get("icon_code") if weather else None,
